		...
		{  
			if (file_exists("upload/".$_SESSION['Username'].'.'.'gif') || file_exists("upload/".$_SESSION['Username'].'.'.'jpeg') || file_exists("upload/".$_SESSION['Username'].'.'.'jpg') || file_exists("upload/".$_SESSION['Username'].'.'.'png')) {
				        ...
				        <div id="sidebar_container">
				            ...
				            <div class="sidebar">
				              ...
				              <form method="post" action="logout.php" id="logout">
				                ...
				                <p><input class="submit" name="subscribe" type="submit" value="Log Out" /></p>
								</div>
				              </form>
				            </div>
					        ...
					        <form action="submitkill.php" method="post" name="submitkill" id="submitkill">
					          <div class="form_settings">
					            <p><span>Kill Details</span><input type="text" name="killdetails" id="killmethod" value="" maxlength="95"/></p>
					            <p style="padding: 15px 0 0px 0;"><span>&nbsp;</span><input class="submit" type="submit" name="submitkill" id="submitkill" value="Submit Kill" /></p>
					          </div>
					        </form>
							</div>
				...
				<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
						...
						<div id="content">
							<h1>Kill anyone on this list</h1>
							<h2>These people did not make a single kill in seven days. Kill them. Hunt them down then email the details of their death to jc563@exeter.ac.uk<h2>
								<p><a href='users-to-kill.pdf'>Click here</a></p>
				...
				<h2>Players Alive: <b><?=$_SESSION['NumberOfPlayersAlive']?>/<?=$_SESSION['NumberOfPlayers']?></h2>
					...
					<p>
						<h1>Your Target</h1>
						<h2>Your target's address has been discovered! <b><?=$_SESSION['Addresst']?></b></h2>
						<ul>
							<?php
				...
				{  
					...
					<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
							...
							<div id="content">
								<h1>Anyone on this list is a target</h1>
								<h2>These people did not make a single kill in seven days. Kill them. Living players can hunt them down then email the details of their death to jc563@exeter.ac.uk<h2>
									<p><a href='users-to-kill.pdf'>Click here</a></p>
